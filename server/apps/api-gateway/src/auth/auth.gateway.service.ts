...
export class AuthGatewayService {
  ...
  @Track()
  async login(body: any, req: AuthenticatedRequest) {
    ...
    const response: AxiosResponse<ResponseDto<any>> = await gatewayAxios.post(
      url,
      body,
      {
        headers: {
  ...
  async refresh(req: AuthenticatedRequest) {
