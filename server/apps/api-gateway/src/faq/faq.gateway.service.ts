...
export class FaqGatewayService {
  ...
  async saveCategory(body: FaqCategoryDTO): Promise<any> {
    const response = await gatewayAxios.post(
  ...
  async getAllCategories(): Promise<any> {
    const response = await gatewayAxios.get(`${this.baseUrl}/category/getAll`);

    return response.data;
  }
  async saveTopic(body: FaqTopicDTO): Promise<any> {
    const response = await gatewayAxios.post(
      `${this.baseUrl}/topic/save`,
      body,
    );
  ...
  async getAllTopics(): Promise<any> {
    const response = await gatewayAxios.get(`${this.baseUrl}/topic/getAll`);
